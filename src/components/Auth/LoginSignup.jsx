...
export const LoginSingup = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (isSignup) {
      ...
      let resulSignup = await apiUsers.singup("auth/login", loginFormData);
    ...
    return (
      <main className="register">
        <section className="register__card">
          ...
          <button onClick={() => setIsSignup(false)}>Iniciar sección</button>
        </section>
      </main>
    );
  }
    ...
    <main className="register">
      <section className="register__card">
        <header className="register__header">
          ...
          <p className="register__description">Ingrese sus credenciales</p>
        </header>
        ...
        <button onClick={() => setIsSignup(true)}>Registrese</button>
      </section>
    </main>
  );
};
